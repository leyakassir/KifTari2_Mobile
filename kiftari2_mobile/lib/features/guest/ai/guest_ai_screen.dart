...
class _GuestAiScreenState extends State<GuestAiScreen> {
  ...
  void initState() {
    ...
    _messages.add(
      const _ChatMessage(
        isUser: false,
        text:
            "I can explain KifTari2, how reporting works, and who can use the app. "
            "I cannot access personal data or specific reports.",
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Guest AI Assistant"),
        centerTitle: true,
      ),
      body: Column(
        children: [
